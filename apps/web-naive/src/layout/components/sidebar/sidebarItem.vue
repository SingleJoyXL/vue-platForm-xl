...
function setClassMenu(path: string) {
...
<template>
  ...
  <el-sub-menu
    ...
    :class="setClassMenu(props.item.path)"
  >
    <template #title>
      <div
        v-if="toRaw(props.item.meta.icon)"
    ...
    <el-menu
      ...
      @select="selectMenu"
    >
      <span v-for="child in props.item.children" :key="child.path">
        <el-menu-item
        ...
        <el-sub-menu v-else class="nav-item" :index="child.path">
